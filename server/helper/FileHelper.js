...
class FileHelper {
            ...
            if (err instanceof multer.MulterError) {
                switch (err.code) {
                    ...
                    case "LIMIT_FILE_SIZE":
                        err.code = 500;
                        err.message = "업로드 가능한 파일 용량를 초과했습니다.";
                        break;
                    default:
                        err.code = 500;
     ...
     * {
     *     fieldname: 'myphoto',
     *     originalname: '원본파일이름.png',
     *     encoding: '7bit',
     *     mimetype: 'image/png',
     *     upload_dir: './_files/upload',
     *     savename: '1671071338675.png',
     *     path: '_files\\upload\\1671071338675.png',
     *     url: '/upload/1671071338675.png'
     * }
     */
